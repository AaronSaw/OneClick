  ...
  <div class="detail">
    <div class="detail-card clearfix">
      ...
      <div class="detail-status">
        ...
        <a href="{{ route('user.order', $detail[0]->id) }}"><button class="order-btn"><i class="fa-solid fa-cart-shopping"></i> Order</button></a>
      </div>
    </div>
  </div>
  <hr class="division">
      ...
      <div class="carousel">
        <div class="carousel-container">
          <div class="carousel-item">
            <img src="{{ asset('storage/' . $conCategory->image) }}" alt="Product Image" class="carousel-item-img">
            <div class="panel">
              <div class="inside">
                <a href="{{ route('detail', $conCategory->id) }}" class="fa-solid fa-circle-info"></a>
              </div>
            </div>
