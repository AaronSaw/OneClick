...
<div class="success-box">
  <span class="success-message">{{ session('success_status') }}<i class="fa-solid fa-xmark icon-order js-close"></i></span>
</div>
@endif
@if (session('error_status'))
<div class="alert-box">
  <span class="alert-message">{{ session('error_status') }}<i class="fa-solid fa-xmark icon-order js-close"></i></span>
</div>
@endif
<div class="order">
  <div class="order-card clearfix">
    ...
    <div class="order-status">
      ...
      <p class="detail-description order-description">{{ $detail[0]->description }}</p>
