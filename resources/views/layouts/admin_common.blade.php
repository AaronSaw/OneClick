...
<body>
  ...
  <div class="clearfix">
    <div class="side-nav">
      ...
      <a href="{{url('/product')}}"><i class="fa fa-eye" aria-hidden="true"></i><span>Product List</span></a>
      <a href="{{url('/product/create')}}"><i class="fa fa-plus" aria-hidden="true"></i><span>Add Product</span></a>
      <p class="pttl">Manage Category</p>
      <a href="{{url('/category')}}"><i class="fa fa-eye" aria-hidden="true"></i><span>Category List</span></a>
      <a href="{{url('/category/create')}}"><i class="fa fa-plus" aria-hidden="true"></i><span>Add Category</span></a>
